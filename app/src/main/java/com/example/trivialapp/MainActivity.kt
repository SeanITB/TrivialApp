            ...
            TrivialAppTheme(settingsVM.darkThem) {
                ...
                Surface(
                    ...
                    NavHost(
                        ...
                        composable(Routes.GameScreen.route) { GameScreen(navigationController, settingsVM, gameVM, windowInfo) }
                        composable(Routes.ResultScreen.route) { ResultScreen(navigationController, settingsVM, gameVM, windowInfo) }
                        composable(Routes.SettingsScreen.route) { SettingsScreen(navigationController, settingsVM, windowInfo) }
                    }
                }
            }
        }
